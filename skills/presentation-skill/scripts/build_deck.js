...
const PRESET_TREATMENTS = {
  ...
  'mozaika-weekly': {
    ...
    footer_source_label: 'Источник',
    footer_refs_label: 'Данные',
    image_sidebar_mode: 'analysis-rail',
    comparison_mode: 'scorecard',
  },
  'mozaika-insight': {
    ...
    header_variant: 'auto',
    header_variants: ['split-rule', 'title-rule', 'side-rail', 'top-bottom-rule', 'plain'],
...
const ICON_CACHE_DIR = path.join(process.env.OUROBOROS_SKILL_STATE_DIR || path.join(__dirname, '..', '.state'), 'icon-cache');
