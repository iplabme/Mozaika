...
function renderTitleSplit(pptx, slide, slideData, preset) {
  ...
  const hasSidePanel = preset.title_side_panel === true && !slideData.__heroPath;
  if (hasSidePanel) {
    slide.addShape('rect', shapeOpts({
      x: 8.28,
      y: 0,
    ...
    slide.addShape('ellipse', shapeOpts({
      ...
      w: 0.78,
      h: 0.78,
      fill: { color: preset.accent_primary, transparency: 100 },
      line: { color: preset.line || 'DCD6CC', width: 1.1, transparency: 20 },
    }));
    slide.addShape('ellipse', shapeOpts({
      x: 8.72,
      y: 5.08,
      ...
      h: 0.52,
      fill: { color: preset.accent_primary, transparency: 100 },
      line: { color: preset.line || 'DCD6CC', width: 1.0, transparency: 20 },
    }));
  }
  ...
  const textRight = hasHero ? 5.3 : (hasSidePanel ? 7.72 : SLIDE_W - MARGIN_X);
