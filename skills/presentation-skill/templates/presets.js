...
const PRESETS = {
  ...
  'mozaika-weekly': {
    ...
    text: '3D3A42',
    text_muted: '7D7774',
    accent_primary: 'B8AEE0',
    accent_secondary: 'A8C6A1',
    line: 'EAE3D9',
    font_heading: 'Georgia',
    font_body: 'Segoe UI',
  },
  'mozaika-insight': {
    ...
    text: '223240',
    text_muted: '5A6E7C',
    accent_primary: '7AA88C',
    accent_secondary: '889EB6',
    accent_tertiary: 'C8A258',
    accent_quaternary: '9E94C6',
    accent_signal: 'C88A7C',
    line: 'DCD6CC',
    status_ok: 'BDD8C6',
    status_warn: 'ECDCAC',
    status_gap: 'ECCCC2',
    status_critical: 'F8CCC8',
    title_side_panel: true,
    font_heading: 'PT Sans Narrow',
    font_body: 'PT Sans',
  },
};
